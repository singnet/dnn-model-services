                ...
                if bboxes == "Fail":
                    ...
                    for idx, box in enumerate(bboxes):
                        ...
                        if self.snet_call_service(name, call_params):
                            ...
                            if top_5 != "Fail":
                                d_tmp = ast.literal_eval(self.snet_call_res_json[name]["response"]["top_5"])
                                top_1 = d_tmp[1]
