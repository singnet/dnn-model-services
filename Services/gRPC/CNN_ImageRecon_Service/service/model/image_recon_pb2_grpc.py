...
from service.model import image_recon_pb2 as service_dot_model_dot_image__recon__pb2
...
class FlowersStub(object):
  ...
  def __init__(self, channel):
    ...
    self.flowers = channel.unary_unary(
        '/Flowers/flowers',
        request_serializer=service_dot_model_dot_image__recon__pb2.ImageReconRequest.SerializeToString,
        response_deserializer=service_dot_model_dot_image__recon__pb2.Result.FromString,
        )
...
def add_FlowersServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'flowers': grpc.unary_unary_rpc_method_handler(
          servicer.flowers,
          request_deserializer=service_dot_model_dot_image__recon__pb2.ImageReconRequest.FromString,
          response_serializer=service_dot_model_dot_image__recon__pb2.Result.SerializeToString,
      ),
  }
