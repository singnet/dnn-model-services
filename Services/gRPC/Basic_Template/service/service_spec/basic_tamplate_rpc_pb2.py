...
# source: service/service_spec/basic_tamplate_rpc.proto
...
Numbers = _reflection.GeneratedProtocolMessageType('Numbers', (_message.Message,), dict(
  DESCRIPTOR = _NUMBERS,
  __module__ = 'service.service_spec.basic_tamplate_rpc_pb2'
