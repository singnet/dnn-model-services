...
from service.service_spec import basic_tamplate_rpc_pb2 as service_dot_service__spec_dot_basic__tamplate__rpc__pb2
...
class AdditionStub(object):
  ...
  def __init__(self, channel):
    ...
    self.add = channel.unary_unary(
        '/Addition/add',
        request_serializer=service_dot_service__spec_dot_basic__tamplate__rpc__pb2.Numbers.SerializeToString,
        response_deserializer=service_dot_service__spec_dot_basic__tamplate__rpc__pb2.Result.FromString,
        )
...
def add_AdditionServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'add': grpc.unary_unary_rpc_method_handler(
          servicer.add,
          request_deserializer=service_dot_service__spec_dot_basic__tamplate__rpc__pb2.Numbers.FromString,
          response_serializer=service_dot_service__spec_dot_basic__tamplate__rpc__pb2.Result.SerializeToString,
      ),
  }
